...
export default function Footer() {
    function handleClick(event:any) {
        ...
        const closestDiv = event.target.closest("div"); // Find the closest parent div
        ...
        <footer className="bg-black w-full p-4 md:p-6 xl:p-[79px_64px_25px_128px] text-white grid md:grid-cols-7">
            ...
            <div className="border-b pb-6 md:border-none border-solid border-[#E5E5E5] md:col-span-4">
                ...
                <form className="w-full flex gap-2 md:gap-4">
                    <input
                        ...
                        className="p-[14px] flex-grow md:max-w-[336px]"
                    />
            ...
            <div className="md:col-span-3 mt-6 md:mt-0">
                ...
                <ul className="flex gap-2">
                    <li className="md:shrink-0 bg-white w-14 h-9 rounded-md grid place-content-center">
                        <Image
                            src={"/G-Pay.svg"}
                            width={0}
                            height={0}
                    ...
                    <li className="shrink-0 bg-white w-14 h-9 rounded-md grid place-content-center">
                        <Image
                            src={"/master-card.svg"}
                            width={0}
                            height={0}
                    ...
                    <li className="shrink-0 bg-[#006FCF] w-14 h-9 rounded-md grid place-content-center">
                        <Image
                            src={"/amex.svg"}
                            width={0}
                            height={0}
                    ...
                    <li className="shrink-0 bg-[#5A31F4] w-14 h-9 rounded-md grid place-content-center">
                        <Image
                            src={"/O-pay.svg"}
                            width={0}
                            height={0}
